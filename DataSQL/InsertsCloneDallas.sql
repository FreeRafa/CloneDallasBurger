...
INSERT INTO Funcionarios (Nome, Cargo, Usuario, SenhaHash) VALUES
...
INSERT INTO Ingredientes (Nome, Tipo, PrecoAdicional, Vegano, DisponivelComoExtra) VALUES
...
-- Produtos: BURGERS
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco, Vegano, PermiteTrocaProteina)
...
FROM Categorias WHERE Nome = 'Burgers';
...
-- Produtos: SIDES
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco, Vegano)
SELECT CategoriaId, 'Coleslaw', NULL, 3.5, 1 FROM Categorias WHERE Nome = 'Sides';
 
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco, Vegano)
SELECT CategoriaId, 'Crispy French Fries', NULL, 3.5, 1 FROM Categorias WHERE Nome = 'Sides';
 
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco, Vegano)
SELECT CategoriaId, 'Cheesy Loaded Fries',
       'Raclette & cheddar sauce, crispy bacon, jalapenos and chives', 5.5, 0
FROM Categorias WHERE Nome = 'Sides';
GO
...
FROM Categorias WHERE Nome = 'Sweet';
GO
 
-- Produtos: BEERS (Dois Corvos Craft Beers)
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco)
SELECT CategoriaId, 'Pilsner', 'Dois Corvos', 3.5 FROM Categorias WHERE Nome = 'Beers';
 
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco)
SELECT CategoriaId, 'IPA', 'Dois Corvos', 3.7 FROM Categorias WHERE Nome = 'Beers';
 
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco)
SELECT CategoriaId, 'Dallas Session IPA', 'Dois Corvos', 4.0 FROM Categorias WHERE Nome = 'Beers';
GO
 
-- Produtos: KOMBUCHAS
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco)
SELECT CategoriaId, 'Ummi Lemon Ginger', 'Alc. 6%', 5.0 FROM Categorias WHERE Nome = 'Kombuchas';
 
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco)
SELECT CategoriaId, 'Ummi Mango Turmeric', 'Alc. 6%', 5.0 FROM Categorias WHERE Nome = 'Kombuchas';
 
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco)
SELECT CategoriaId, 'Bouche Lemondrop', NULL, 4.5 FROM Categorias WHERE Nome = 'Kombuchas';
 
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco)
SELECT CategoriaId, 'Bouche Earlybird', NULL, 4.5 FROM Categorias WHERE Nome = 'Kombuchas';
GO
 
-- Produtos: DRINKS
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco)
SELECT CategoriaId, 'Coke / Coke Zero', NULL, 3.5 FROM Categorias WHERE Nome = 'Drinks';
 
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco)
SELECT CategoriaId, 'Homemade Iced Tea', NULL, 3.5 FROM Categorias WHERE Nome = 'Drinks';
 
INSERT INTO Produtos (CategoriaId, Nome, Descricao, Preco)
SELECT CategoriaId, 'Purified Water (70cl)', NULL, 2.5 FROM Categorias WHERE Nome = 'Drinks';
GO
